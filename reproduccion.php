...
<body>
    ...
    <section id="video">
        ...
        <div id="hashtag" class="floatizq">
            <p><a href="#">#Viajes</a> <a href="#">#Roraima</a> <a href="#">#Venezuela</a> <a href="#">#Naturaleza</a> <a href="#">#Aventura</a></p>
        </div>
    </section>
<!-- info video y social-->
    <section id="comentarios">
        <div class="floatizq">
            ...
            <div>
             <a href="#" class="redondito">Cargar más comentarios</a>
            </div>
        </div>
    </section>
    <section id="infodestino">
        ...
        <div>
            ...
            <div class="floatder">
                <a href="#" class="redondito">Ver más</a>
            </div>
        </div>
    </section>
    <section id="vidrelacionados">
        <div>
